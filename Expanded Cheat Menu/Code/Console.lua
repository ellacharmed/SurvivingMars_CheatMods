...
function ChoGGi_Funcs.Console.BuildExamineMenu()
	...
	AddSubmenu("GlobalVars", nil, "GameVars", "GameVarValues", "GlobalVarValues", "PersistableGlobals", "GetLuaSaveGameData", "GetLuaLoadGamePermanents", "GlobalObjs", "GlobalObjClasses", "GlobalGameTimeThreads", "GlobalGameTimeThreadFuncs", "GlobalRealTimeThreads", "GlobalRealTimeThreadFuncs")
	...
	AddSubmenu("StoryBits", "Story Bits", "g_StoryBitsLog", "g_StoryBitStates", "g_StoryBitCategoryStates", "StoryBitCategories", "StoryBitTriggersCombo", "g_StoryBitActive")
