...
Allow Out Of Bounds: Turn on to landscape out of bounds (Crash warning near edge of map, save first).
Allow All Environments: Allows you to build underground and on asteroids (Crash warning near edge of map, save first).
]],
})
